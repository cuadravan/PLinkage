...
{
    public partial class ProjectOwnerApplicationOfferViewModel : ObservableObject
    {
        // Services
        ...
        // Properties
        [ObservableProperty] private List<OfferApplicationDisplayModel> sentOffersPending;
        [ObservableProperty] private List<OfferApplicationDisplayModel> receivedApplicationsPending;
        [ObservableProperty] private List<OfferApplicationDisplayModel> sentOffersHistory;
        [ObservableProperty] private List<OfferApplicationDisplayModel> receivedApplicationsHistory;


        public ProjectOwnerApplicationOfferViewModel(
            ...
            INavigationService navigationService)
        {
            ...
            ApproveApplicationCommand = new AsyncRelayCommand<OfferApplicationDisplayModel>(ApproveApplication);
            RejectApplicationCommand = new AsyncRelayCommand<OfferApplicationDisplayModel>(RejectApplication);
        }

        public IAsyncRelayCommand LoadDataCommand { get; }
        public IAsyncRelayCommand<OfferApplicationDisplayModel> ApproveApplicationCommand { get; }
        public IAsyncRelayCommand<OfferApplicationDisplayModel> RejectApplicationCommand { get; }
        ...
        private async Task LoadData()
        {
            ...
            var offerApplicationIds = projectOwner.OfferApplicationId;
            ...
            ReceivedApplicationsHistory = allOffers
                .Where(o => offerApplicationIds.Contains(o.OfferApplicationId)
                            && o.ReceiverId == projectOwnerId
                            && o.OfferApplicationType == "Application"
                            && (o.OfferApplicationStatus == "Accepted" || o.OfferApplicationStatus == "Rejected"))
        ...
        private async Task ApproveApplication(OfferApplicationDisplayModel display)
        {
        ...
        private async Task RejectApplication(OfferApplicationDisplayModel display)
        {
