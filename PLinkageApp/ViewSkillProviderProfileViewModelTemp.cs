...
namespace PLinkageApp
{
    ...
    public partial class ViewSkillProviderProfileViewModelTemp: ObservableObject
    {
        ...
        public ViewSkillProviderProfileViewModelTemp(ISessionService sessionService, IAccountServiceClient accountServiceClient, ISkillProviderServiceClient skillProviderServiceClient, INavigationService navigationService)
        {
